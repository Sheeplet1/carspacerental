...
const EditProfileModal = ({ showEditProfileModal, setShowEditProfileModal }) => {
  ...
  const clickSave = async () => {
    ...
    if (isEmailValid && isFirstNameValid && isLastNameValid && isPhoneNumberValid) {
      const body = {
        "email": email,
  ...
  return (
    <>
      <Button className='bg-custom-orange hover:bg-custom-orange-dark text-white' onClick={() => setShowEditProfileModal(true)}>Edit Profile</Button>
      <Modal show={showEditProfileModal} onClose={closeModal} root={ref.current}>
        <Modal.Header className='bg-custom-orange text-white'>Edit Profile</Modal.Header>
        <Modal.Body>
          <div className='flex flex-col'>
            <div>
              ...
              <input id='email' className='w-full border-2 border-gray-300 rounded-3xl p-2 mt-2 mb-4' type='text' value={email} onChange={(e) => setEmail(e.target.value)} />
            ...
            <div>
              ...
              <input id='firstName' className='w-full border-2 border-gray-300 rounded-3xl p-2 mt-2 mb-4' type='text' value={firstName} onChange={(e) => setFirstName(e.target.value)} />
            ...
            <div>
              ...
              <input id='lastName' className='w-full border-2 border-gray-300 rounded-3xl p-2 mt-2 mb-4' type='text' value={lastName} onChange={(e) => setLastName(e.target.value)} />
            ...
            <div>
              ...
              <input id='phoneNumber' className='w-full border-2 border-gray-300 rounded-3xl p-2 mt-2 mb-4' type='number' value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />

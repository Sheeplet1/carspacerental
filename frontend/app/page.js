...
const Home = () => {
  ...
  return (
    <div className="flex flex-col justify-between items-center mt-10">
      <div className="flex justify-between items-center w-full" style={{ height: '40vh' }}>
        <div className="flex flex-col items-start gap-4 mr-44 w-full">
          ...
          <label className="text-md text-gray-400">Car rent services for various terrain with guaranteed quality</label>

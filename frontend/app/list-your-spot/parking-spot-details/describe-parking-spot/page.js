...
const DescribeParkingSpot = () => {
  ...
  const [describeParkingSpaceError, setDescribeParkingSpaceError] = useState('');
  ...
  return (
    <div className='flex flex-row h-screen'>
      ...
      <div className='relative bottom-14 flex flex-col mr-44'>
        ...
        <textarea
          className={`w-96 h-32 border-2 border-gray-300 rounded-3xl p-2 resize-none text-xs ${describeParkingSpaceError ? 'border-red-500' : ''}`}
        ...
        {describeParkingSpaceError && <p className='text-red-500 mt-2'>{describeParkingSpaceError}</p>}

        <label className='mb-2 mt-4'>Instructions for drivers:</label>
        <textarea
          className={`w-96 h-32 border-2 border-gray-300 rounded-3xl p-2 resize-none text-xs ${driverInstructionsError ? 'border-red-500' : ''}`}
        ...
        {driverInstructionsError && <p className='text-red-500 mt-2'>{driverInstructionsError}</p>}

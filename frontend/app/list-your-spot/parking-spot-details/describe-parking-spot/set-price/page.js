...
const SetPrice = () => {
  ...
  const handleNextClick = () => {
    ...
    if ((isHourlyActive && hourlyValid) || (isMonthlyActive && monthlyValid)) {
      router.push(
        "/list-your-spot/parking-spot-details/describe-parking-spot/set-price/confirm-listing"
      );
    }
  };
    ...
    <div className="flex flex-row w-full mt-12">
      ...
      <div className="relative bottom-14 flex flex-col mr-44">
        ...
        <div className="flex items-center mb-4">
          <div
            className={`${
              isHourlyActive ? "bg-custom-blue" : "bg-gray-300"
        ...
        <div className="flex items-center mb-4">
          <div
            className={`${
              isMonthlyActive ? "bg-custom-blue" : "bg-gray-300"
            } w-6 h-6 rounded-full p-1 flex items-center cursor-pointer mr-2`}
        ...
        {errorMessage && (
          <p className="text-red-500 mb-4 bg-red-100 py-2 px-4 text-center">
            {errorMessage}
          </p>
        )}
